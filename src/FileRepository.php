...
use Savannabits\Modules\Exceptions\InvalidAssetPath;
use Savannabits\Modules\Exceptions\ModuleNotFoundException;
use Savannabits\Modules\Process\Installer;
use Savannabits\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Savannabits\Modules\Exceptions\ModuleNotFoundException
     */
