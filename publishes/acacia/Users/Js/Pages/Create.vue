<template>
    <Head :title="`New User`"> </Head>
    <Backend>
        <template #header>
            <div class="flex items-center flex-wrap gap-x-2">
                <BackLink :href="route('acacia.backend.users.index')" />
                <h4 class="font-bold text-xl">New User</h4>
            </div>
        </template>
        <div
...
const onCreated = (e) => {
    ...
    Inertia.visit(route("acacia.backend.users.index"));
};
</script>
<style scoped></style>
