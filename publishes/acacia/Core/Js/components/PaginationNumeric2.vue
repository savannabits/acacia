  ...
  <div>
    <nav class="flex justify-between" role="navigation" aria-label="Navigation">
      <div class="flex-1 mr-2">
        <a class="btn bg-white border-gray-200 text-gray-300 cursor-not-allowed" href="#0" disabled>&lt;-<span class="hidden sm:inline">&nbsp;Previous</span></a>
      </div>
      ...
      <div class="flex-1 text-right ml-2">
        <a class="btn bg-white border-gray-200 hover:border-gray-300 text-indigo-500" href="#0"><span class="hidden sm:inline">Next&nbsp;</span>-&gt;</a>
      </div>
    </nav>
  </div>
</template>
