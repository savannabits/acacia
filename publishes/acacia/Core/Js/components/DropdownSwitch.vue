<template>
  <div class="relative">
    ...
    >
      <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full left-0 min-w-60 bg-white border border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1">
        <ul
          ref="dropdown"
        ...
        >
          <li>
            <a class="font-medium text-sm text-gray-600 hover:text-gray-800 block py-1.5 px-3" href="#0" @click="dropdownOpen = false">
