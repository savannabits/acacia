<template>
    <div class="relative inline-flex">
        ...
        >
            <img class="w-8 h-8 rounded-full" :src="user?.image_url ?? userAvatar" width="32" height="32" alt="L"/>
        ...
        >
            <div v-show="dropdownOpen"
                ...
                <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
                    ...
                    <div class="text-xs text-gray-500 italic">{{ user.email }}</div>
                </div>
                <ul
                    ref="dropdown"
                ...
                >
                    <li>
                        <router-link
                            ...
                            href="#" @click="dropdownOpen = false">My Account
                        </router-link>
                    </li>
                    <li>
                        <router-link
...
export default {
    ...
    setup() {
        ...
        const user = computed(() => (usePage() as any).props.value.auth?.user);
