<template>
  <div class="grow">
    ...
    <div class="p-6 space-y-6">
      ...
      <!-- Business Profile -->
      <section>
        <h3 class="text-xl leading-snug text-gray-800 font-bold mb-1">Business Profile</h3>
      ...
      <!-- Email -->
      <section>
        <h3 class="text-xl leading-snug text-gray-800 font-bold mb-1">Email</h3>
      ...
      <!-- Password -->
      <section>
        <h3 class="text-xl leading-snug text-gray-800 font-bold mb-1">Password</h3>
      ...
      <!-- Smart Sync -->
      <section>
        <h3 class="text-xl leading-snug text-gray-800 font-bold mb-1">Smart Sync update for Mac</h3>
