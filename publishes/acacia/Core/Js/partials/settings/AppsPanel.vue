<template>
  <div class="grow">
    ...
    <div class="p-6">
      ...
      <div class="mb-6">
        ...
        <div class="mb-4 border-b border-gray-200">
          <ul class="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            ...
            <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a class="text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Utility</a>
            </li>
            <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  ...
                  <h3 class="text-lg text-gray-800 font-semibold">MaterialStack</h3>
                </header>
                ...
                <div class="flex flex-wrap justify-between items-center">
                  ...
                  <div class="flex space-x-3">
                    <div class="flex items-center text-gray-400">
                      ...
                      <div class="text-sm text-gray-500">4K+</div>
                    </div>
                    <div class="flex items-center text-yellow-500">
                      <svg class="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
                        <path d="M10 5.934L8 0 6 5.934H0l4.89 3.954L2.968 16 8 12.223 13.032 16 11.11 9.888 16 5.934z" />
                      </svg>
                      <div class="text-sm text-yellow-600">4.7</div>
                    </div>
                  </div>
                  <!-- Right side -->
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-green-500 to-green-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-light-blue-500 to-light-blue-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-red-500 to-red-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-yellow-500 to-yellow-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
          ...
          <div class="col-span-full xl:col-span-6 2xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header class="flex items-center mb-4">
                  <div class="w-10 h-10 rounded-full shrink-0 bg-gradient-to-tr from-gray-500 to-gray-300 mr-3">
                    <svg class="w-10 h-10 fill-current text-white" viewBox="0 0 40 40">
                      <path d="M26.946 18.005a.583.583 0 00-.53-.34h-6.252l.985-3.942a.583.583 0 00-1.008-.52l-7 8.167a.583.583 0 00.442.962h6.252l-.984 3.943a.583.583 0 001.008.52l7-8.167a.583.583 0 00.087-.623z" />
                    </svg>
                  </div>
      ...
      <section>
        <h3 class="text-xl leading-snug text-gray-800 font-bold mt-6 mb-5">Trending Categories</h3>
        <div class="grid grid-cols-12 gap-6">
          <!-- Card 1 -->
          <div class="col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header>
                  <h3 class="text-lg text-gray-800 font-semibold mb-1">Programming</h3>
                </header>
              </div>
              <!-- Card footer -->
              <footer class="mt-2">
                <div class="flex flex-wrap justify-between items-center">
                  <!-- Left side -->
                  <div class="text-sm text-gray-500 italic">400+ Apps</div>
                  <!-- Right side -->
          ...
          <div class="col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header>
                  <h3 class="text-lg text-gray-800 font-semibold mb-1">Digital Marketing</h3>
                </header>
              </div>
              <!-- Card footer -->
              <footer class="mt-2">
                <div class="flex flex-wrap justify-between items-center">
                  <!-- Left side -->
                  <div class="text-sm text-gray-500 italic">320+ Apps</div>
                  <!-- Right side -->
                  <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">Explore -&gt;</a>
                </div>
              </footer>
          ...
          <div class="col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
            ...
            <div class="flex flex-col h-full p-5">
              <div class="grow">
                <header>
                  <h3 class="text-lg text-gray-800 font-semibold mb-1">Music & Audio</h3>
                </header>
              </div>
              <!-- Card footer -->
              <footer class="mt-2">
                <div class="flex flex-wrap justify-between items-center">
                  <!-- Left side -->
                  <div class="text-sm text-gray-500 italic">270+ Apps</div>
                  <!-- Right side -->
                  <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600" href="#0">Explore -&gt;</a>
                </div>
              </footer>
