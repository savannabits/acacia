<template>
  <div class="grow">
    ...
    <div class="p-6 space-y-6">
      ...
      <section>
        <div class="mb-8">
          <h2 class="text-2xl text-gray-800 font-bold mb-4">Plans</h2>
        ...
        <div>
          ...
          <div class="grid grid-cols-12 gap-6">
            <!-- Tab 1 -->
            <div class="relative col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
              ...
              <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                <header class="flex items-center mb-2">
                  <div class="w-6 h-6 rounded-full shrink-0 bg-gradient-to-tr from-green-500 to-green-300 mr-3">
                ...
                <div class="text-gray-800 font-bold mb-4">
                  <span class="text-2xl">$</span><span class="text-3xl">{{ annual ? '14' : '19'}}</span><span class="text-gray-500 font-medium text-sm">/mo</span>
                </div>
                <!-- CTA -->
                <button class="btn border-gray-200 hover:border-gray-300 text-gray-600 w-full">Downgrade</button>
              </div>
            ...
            <!-- Tab 2 -->
            <div class="relative col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
              <div class="absolute top-0 left-0 right-0 h-0.5 bg-light-blue-500" aria-hidden="true"></div>
              <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                <header class="flex items-center mb-2">
                  <div class="w-6 h-6 rounded-full shrink-0 bg-gradient-to-tr from-light-blue-500 to-light-blue-300 mr-3">
                    <svg class="w-6 h-6 fill-current text-white" viewBox="0 0 24 24">
                      <path d="M12 17a.833.833 0 01-.833-.833 3.333 3.333 0 00-3.334-3.334.833.833 0 110-1.666 3.333 3.333 0 003.334-3.334.833.833 0 111.666 0 3.333 3.333 0 003.334 3.334.833.833 0 110 1.666 3.333 3.333 0 00-3.334 3.334c0 .46-.373.833-.833.833z" />
                    </svg>
                  </div>
                ...
                <!-- Price -->
                <div class="text-gray-800 font-bold mb-4">
                  <span class="text-2xl">$</span><span class="text-3xl">{{ annual ? '34' : '39'}}</span><span class="text-gray-500 font-medium text-sm">/mo</span>
                </div>
                <!-- CTA -->
                <button class="btn border-gray-200 bg-gray-100 text-gray-400 w-full cursor-not-allowed flex items-center" disabled>
            ...
            <div class="relative col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
              ...
              <div class="px-5 pt-5 pb-6 border-b border-gray-200">
                ...
                <!-- Price -->
                <div class="text-gray-800 font-bold mb-4">
                  <span class="text-2xl">$</span><span class="text-3xl">{{ annual ? '74' : '79'}}</span><span class="text-gray-500 font-medium text-sm">/mo</span>
                </div>
                <!-- CTA -->
      ...
      <section>
        <div class="px-5 py-3 bg-indigo-50 border border-indigo-100 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
          <div class="text-gray-800 font-semibold mb-2 xl:mb-0">Looking for different configurations?</div>
      ...
      <section>
        <div class="my-8">
          <h2 class="text-2xl text-gray-800 font-bold">FAQs</h2>
        </div>
        <ul class="space-y-5">
          <li>
