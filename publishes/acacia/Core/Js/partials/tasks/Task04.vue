<template>
  <div class="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
    ...
    <div class="mb-3">
      <!-- Title -->
      <h2 class="font-semibold text-gray-800 mb-1">Managing teams (book)</h2>
    </div>
    <!-- Meta -->
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        <!-- To-do info -->
        <div class="flex items-center text-gray-400 ml-3">
    ...
    <!-- List -->
    <ul class="mt-3">
      <li class="flex items-center border-t border-gray-200 py-2">
        <svg class="w-3 h-3 shrink-0 fill-current text-green-500 mr-2" viewBox="0 0 12 12">
          <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
        </svg>
        <div class="text-sm text-gray-400 line-through">Implement new designs</div>
      </li>
      <li class="flex items-center border-t border-gray-200 py-2">
        <svg class="w-3 h-3 shrink-0 fill-current text-gray-400 mr-2" viewBox="0 0 12 12">
          <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
        </svg>
