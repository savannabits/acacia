<template>
  <div class="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
    ...
    <div class="mb-3">
      ...
      <div class="flex items-center mb-2">
        ...
        <div class="grow">
          <a class="inline-flex text-gray-800 hover:text-gray-900" href="#0">
            <h2 class="font-semibold text-gray-800">Adrian Przetocki</h2>
          </a>
      ...
      <!-- Content -->
      <div>
        <div class="text-sm">Dedicated form for a category of users that will perform actions? <a class="font-medium text-indigo-500 hover:text-indigo-600" href="#0">#viewall</a></div>
      </div>
    </div>
    <!-- Footer -->
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
        <!-- Like button -->
        <button class="flex items-center text-gray-400 hover:text-indigo-500 ml-3">
