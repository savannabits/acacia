    ...
    <Backend>
        ...
        <div class="p-2 mt-2">
            ...
            >
                ...
                <Column field="session_date" header="Session Date" :sortable="true"/>
                <Column field="user.name" header="Sent By" :sortable="true"/>
                <Column field="draft_message" header="Draft Message" :sortable="true"/>
                <Column field="session_cost" header="Session Cost" :sortable="true"/>
                <Column>
                    <template #body="props">
                        <Button class=""
...
export default defineComponent({
    ...
    setup() {
        const title = "Sms Sending Sessions";
        const apiUrl = route('api.sms.sending-sessions.index');
        const dtId = 'sms-sending-sessions-dt';
        const searchableColumns = ref(['id','user.name','session_date','draft_message']);
