    ...
    <Backend>
        ...
        <div class="p-2 mt-2">
            ...
            >
                ...
                <Column field="sending_session.session_date" header="Session Date" :sortable="true"/>
                <Column field="sending_session.user.name" header="Sent By" :sortable="true"/>
...
export default defineComponent({
    ...
    setup() {
        ...
        const apiUrl = route('api.sms.messages.index');
        const dtId = 'sms-messages-dt';
        const searchableColumns = ref(['id','sendingSession.session_date','atxid','recipient','status','cost']);
