<template>
    ...
    <Backend>
        <template #header>
            <h4 class="font-black text-2xl px-1 md:px-4">Permissions</h4>
        </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">New Permission</h4>
            </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">Edit Single Permission</h4>
            </template>
            <EditForm
                :model="currentModel"
                @updated="onUpdated"
...
const fetchModel = async (row) => {
    axios
        .get(route("api.v1.permissions.show", row))
        .then((res) => {
...
const deleteModel = async function (row) {
    try {
        const res = await axios.delete(
            route("api.v1.permissions.destroy", row as any)
        );
        toast.add({
            severity: "success",
