<template>
    ...
    <Backend>
        <template #header>
            <h4 class="font-black text-2xl px-1 md:px-4">Schematics</h4>
        </template>
                ...
                >
                    ...
                    >
                        <template #body="{ data }">
                            <span>{{
                                data.generated_at
                                    ? dayjs(data.generated_at).format(
                                          "MMM DD, YYYY hh:mm a"
                                      )
                                    : "-"
                            }}</span>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">New Schematic</h4>
            </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">Schematic Details</h4>
            </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">Edit Single Schematic</h4>
            </template>
            <EditForm
                :model="currentModel"
                @updated="onUpdated"
