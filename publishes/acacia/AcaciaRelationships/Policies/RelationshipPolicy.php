...
namespace Acacia\AcaciaRelationships\Policies;
...
class RelationshipPolicy
{
     ...
     * @return Response|bool
     */
    public function view(AuthUser $user, Relationship $model): Response|bool
    {
     ...
     * @return Response|bool
     */
    public function update(AuthUser $user, Relationship $model): Response|bool
    {
     ...
     * @return Response|bool
     */
    public function delete(AuthUser $user, Relationship $model): Response|bool
    {
     ...
     * @return Response|bool
     */
    public function restore(AuthUser $user, Relationship $model): Response|bool
    {
