<template>
    ...
    <Backend>
        <template #header>
            <h4 class="font-black text-2xl px-1 md:px-4">Relationships</h4>
        </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">New Relationship</h4>
            </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">Relationship Details</h4>
            </template>
        ...
        >
            <template #header>
                <h4 class="font-black text-xl">Edit Single Relationship</h4>
            </template>
            <EditForm
                :model="currentModel"
                @updated="onUpdated"
